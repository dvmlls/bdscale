...
The package determined this gives you the largest number of breaks weakly less than the default maximum, which is `5`. 

If you tell it to use more, it can put breaks on the first day of the week:
